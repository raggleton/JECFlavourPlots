...
if __name__ == "__main__":
    ...
    do_all_2d_plots(
        cu.open_root_file(os.path.join(PY8_CP5_DIR, "Closure_ak4pfchs_QCD_Pt_15toInf_Py8_CP5_NoJEC_newFlav__relRspMax2_relPtHatMax2p5_ptGenMin750_ptGenMax1000_nrefmax2_ud.root")),
        os.path.join(PY8_CP5_DIR, "Closure_ak4pfchs_QCD_Pt_15toInf_Py8_CP5_NoJEC_newFlav__relRspMax2_relPtHatMax2p5_ptGenMin750_ptGenMax1000_nrefmax2_ud_plots_2d")
    )
    do_all_2d_plots(
        cu.open_root_file(os.path.join(PY8_CP5_DIR, "Closure_ak4pfchs_QCD_Pt_15toInf_Py8_CP5_NoJEC_newFlav__relRspMax2_relPtHatMax2p5_ptGenMin72_ptGenMax90_nrefmax2_ud.root")),
        os.path.join(PY8_CP5_DIR, "Closure_ak4pfchs_QCD_Pt_15toInf_Py8_CP5_NoJEC_newFlav__relRspMax2_relPtHatMax2p5_ptGenMin72_ptGenMax90_nrefmax2_ud_plots_2d")
    )
    ...
    do_all_2d_plots(
        cu.open_root_file(os.path.join(H7_DIR, "Closure_ak4pfchsQCD_Pt_15to7000_Herwig7_NoJEC_miniaod__relRspMax2_relPtHatMax2p5_ptGenMin750_ptGenMax1000_nrefmax2_s_0.root")),
        os.path.join(H7_DIR, "Closure_ak4pfchsQCD_Pt_15to7000_Herwig7_NoJEC_miniaod__relRspMax2_relPtHatMax2p5_ptGenMin750_ptGenMax1000_nrefmax2_s_plots_2d")
    )
    do_all_2d_plots(
        cu.open_root_file(os.path.join(H7_DIR, "Closure_ak4pfchsQCD_Pt_15to7000_Herwig7_NoJEC_miniaod__relRspMax2_relPtHatMax2p5_ptGenMin72_ptGenMax90_nrefmax2_s_0.root")),
        os.path.join(H7_DIR, "Closure_ak4pfchsQCD_Pt_15to7000_Herwig7_NoJEC_miniaod__relRspMax2_relPtHatMax2p5_ptGenMin72_ptGenMax90_nrefmax2_s_plots_2d")
    )
